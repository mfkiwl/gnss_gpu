...
_RTKDIAG_POLICIES = {
    ...
    "phase11x", "phase11y", "phase11z", "phase11aa", "phase11ab", "phase11ac", "phase11ad", "phase11ae", "phase11af", "phase11ag", "phase11ah", "phase11ai", "phase11aj", "phase11ak", "phase11al", "phase11am", "phase11an", "phase11ao", "phase11ap", "phase11aq", "phase11ar", "phase11as", "phase11at", "phase11au", "phase11aw", "phase11ay",
}
...
def _apply_rtkdiag_run_index_policy(
    ...
    *,
    ...
    if (
        ...
        return variant
    if policy in {"phase11aa", "phase11ab", "phase11ac", "phase11ad", "phase11ae", "phase11af", "phase11ag", "phase11ah", "phase11ai", "phase11aj", "phase11ak", "phase11al", "phase11am", "phase11an", "phase11ao", "phase11ap", "phase11aq", "phase11ar", "phase11as", "phase11at", "phase11au", "phase11aw", "phase11ay"}:
...
def _filter_rtkdiag_candidates_by_policy(
    ...
    *,
    ...
    if policy in {"phase11h", "phase11i", "phase11l", "phase11n", "phase11x", "phase11y", "phase11z", "phase11aa", "phase11ab", "phase11ac", "phase11ad", "phase11ae", "phase11af", "phase11ag", "phase11ah", "phase11ai", "phase11aj", "phase11ak", "phase11al", "phase11am", "phase11an", "phase11ao", "phase11ap", "phase11aq", "phase11ar", "phase11as", "phase11at", "phase11au", "phase11aw", "phase11ay"} and city == "nagoya" and run == "run2":
        effective_blocked_labels.update({"r15g15", "r20g15", "r25g15", "r30g15"})
    if policy in {"phase11i", "phase11l", "phase11n", "phase11x", "phase11y", "phase11z", "phase11aa", "phase11ab", "phase11ac", "phase11ad", "phase11ae", "phase11af", "phase11ag", "phase11ah", "phase11ai", "phase11aj", "phase11ak", "phase11al", "phase11am", "phase11an", "phase11ao", "phase11ap", "phase11aq", "phase11ar", "phase11as", "phase11at", "phase11au", "phase11aw", "phase11ay"} and (
        (city, run) in {("tokyo", "run2"), ("nagoya", "run1"), ("nagoya", "run2")}
    ):
        effective_blocked_labels.update({"r30", "r30g"})
    if policy in {"phase11l", "phase11n", "phase11x", "phase11y", "phase11z", "phase11aa", "phase11ab", "phase11ac", "phase11ad", "phase11ae", "phase11af", "phase11ag", "phase11ah", "phase11ai", "phase11aj", "phase11ak", "phase11al", "phase11am", "phase11an", "phase11ao", "phase11ap", "phase11aq", "phase11ar", "phase11as", "phase11at", "phase11au", "phase11aw", "phase11ay"} and (
        (city, run) in {("nagoya", "run1"), ("nagoya", "run2")}
    ):
        effective_blocked_labels.add("r20g10")
    if policy in {"phase11n", "phase11x", "phase11y", "phase11z", "phase11aa", "phase11ab", "phase11ac", "phase11ad", "phase11ae", "phase11af", "phase11ag", "phase11ah", "phase11ai", "phase11aj", "phase11ak", "phase11al", "phase11am", "phase11an", "phase11ao", "phase11ap", "phase11aq", "phase11ar", "phase11as", "phase11at", "phase11au", "phase11aw", "phase11ay"} and city == "nagoya":
    ...
    if policy in {"phase11ab", "phase11ac", "phase11ad", "phase11ae", "phase11af", "phase11ag", "phase11ah", "phase11ai", "phase11aj", "phase11ak", "phase11al", "phase11am", "phase11an", "phase11ao", "phase11ap", "phase11aq", "phase11ar", "phase11as", "phase11at", "phase11au", "phase11aw", "phase11ay"} and (city, run) not in {("tokyo", "run3"), ("nagoya", "run1")}:
    ...
    if policy in {"phase11ac", "phase11ad", "phase11ae", "phase11af", "phase11ag", "phase11ah", "phase11ai", "phase11aj", "phase11ak", "phase11al", "phase11am", "phase11an", "phase11ao", "phase11ap", "phase11aq", "phase11ar", "phase11as", "phase11at", "phase11au", "phase11aw", "phase11ay"} and (city, run) not in {("tokyo", "run3"), ("nagoya", "run2")}:
    ...
    if policy in {"phase11af", "phase11ag", "phase11ah", "phase11ai", "phase11aj", "phase11ak", "phase11al", "phase11am", "phase11an", "phase11ao", "phase11ap", "phase11aq", "phase11ar", "phase11as", "phase11at", "phase11au", "phase11aw", "phase11ay"} and (city, run) not in {("tokyo", "run3"), ("nagoya", "run1")}:
        effective_blocked_labels.add("em10")
    ...
    if policy in {"phase11af", "phase11ag", "phase11ah", "phase11ai", "phase11aj", "phase11ak", "phase11al", "phase11am", "phase11an", "phase11ao", "phase11ap", "phase11aq", "phase11ar", "phase11as", "phase11at", "phase11au", "phase11aw", "phase11ay"} and (city, run) not in {("tokyo", "run3"), ("nagoya", "run3")}:
        effective_blocked_labels.add("psig1")
    # Phase 11ad: holdrlx (relaxed hold ambiguity) gives +72m only on
    # tokyo/run3.
    if policy in {"phase11ad", "phase11ae", "phase11af", "phase11ag", "phase11ah", "phase11ai", "phase11aj", "phase11ak", "phase11al", "phase11am", "phase11an", "phase11ao", "phase11ap", "phase11aq", "phase11ar", "phase11as", "phase11at", "phase11au", "phase11aw", "phase11ay"} and (city, run) != ("tokyo", "run3"):
    ...
    if policy in {"phase11ae", "phase11af", "phase11ag", "phase11ah", "phase11ai", "phase11aj", "phase11ak", "phase11al", "phase11am", "phase11an", "phase11ao", "phase11ap", "phase11aq", "phase11ar", "phase11as", "phase11at", "phase11au", "phase11aw", "phase11ay"} and (city, run) != ("tokyo", "run3"):
    ...
    if policy in {"phase11af", "phase11ag", "phase11ah", "phase11ai", "phase11aj", "phase11ak", "phase11al", "phase11am", "phase11an", "phase11ao", "phase11ap", "phase11aq", "phase11ar", "phase11as", "phase11at", "phase11au", "phase11aw", "phase11ay"} and (city, run) != ("tokyo", "run3"):
    ...
    if policy in {"phase11af", "phase11ag", "phase11ah", "phase11ai", "phase11aj", "phase11ak", "phase11al", "phase11am", "phase11an", "phase11ao", "phase11ap", "phase11aq", "phase11ar", "phase11as", "phase11at", "phase11au", "phase11aw", "phase11ay"} and (city, run) not in {("nagoya", "run2"), ("tokyo", "run3"), ("tokyo", "run1")}:
    ...
    if policy in {"phase11am", "phase11an", "phase11ao", "phase11ap", "phase11aq", "phase11ar", "phase11as", "phase11at", "phase11au", "phase11aw", "phase11ay"} and (city, run) not in {("tokyo", "run3"), ("nagoya", "run2"), ("tokyo", "run1"), ("nagoya", "run3")}:
        effective_blocked_labels.add("csig05")
    # Phase 11ag: noglo (--no-glonass) gives +40.5m on tokyo/run1 only.
    if policy in {"phase11ag", "phase11ah", "phase11ai", "phase11aj", "phase11ak", "phase11al", "phase11am", "phase11an", "phase11ao", "phase11ap", "phase11aq", "phase11ar", "phase11as", "phase11at", "phase11au", "phase11aw", "phase11ay"} and (city, run) != ("tokyo", "run1"):
    ...
    if policy in {"phase11ah", "phase11ai", "phase11aj", "phase11ak", "phase11al", "phase11am", "phase11an", "phase11ao", "phase11ap", "phase11aq", "phase11ar", "phase11as", "phase11at", "phase11au", "phase11aw", "phase11ay"} and (city, run) not in {("nagoya", "run1"), ("nagoya", "run2"), ("tokyo", "run3")}:
        effective_blocked_labels.add("csig1")
    # Phase 11ah: rout30 (--rtk-update-outlier-threshold 30) gives +3.6m
    # on nagoya/run3 only.
    if policy in {"phase11ah", "phase11ai", "phase11aj", "phase11ak", "phase11al", "phase11am", "phase11an", "phase11ao", "phase11ap", "phase11aq", "phase11ar", "phase11as", "phase11at", "phase11au", "phase11aw", "phase11ay"} and (city, run) != ("nagoya", "run3"):
        effective_blocked_labels.add("rout30")
    # Phase 11ah: rout20 (--rtk-update-outlier-threshold 20) gives +2.2m
    # on nagoya/run1 only.
    if policy in {"phase11ah", "phase11ai", "phase11aj", "phase11ak", "phase11al", "phase11am", "phase11an", "phase11ao", "phase11ap", "phase11aq", "phase11ar", "phase11as", "phase11at", "phase11au", "phase11aw", "phase11ay"} and (city, run) != ("nagoya", "run1"):
    ...
    if policy in {"phase11ai", "phase11aj", "phase11ak", "phase11al", "phase11am", "phase11an", "phase11ao", "phase11ap", "phase11aq", "phase11ar", "phase11as", "phase11at", "phase11au", "phase11aw", "phase11ay"} and (city, run) not in {("tokyo", "run1"), ("tokyo", "run3"), ("nagoya", "run3")}:
    ...
    if policy in {"phase11ai", "phase11ak", "phase11al", "phase11am", "phase11an", "phase11ao", "phase11ap", "phase11aq", "phase11ar", "phase11as", "phase11at", "phase11au", "phase11aw", "phase11ay"} and (city, run) not in {("tokyo", "run3"), ("nagoya", "run1")}:
    ...
    if policy in {"phase11ak", "phase11al", "phase11am", "phase11an", "phase11ao", "phase11ap", "phase11aq", "phase11ar", "phase11as", "phase11at", "phase11au", "phase11aw", "phase11ay"} and (city, run) not in {("tokyo", "run3"), ("nagoya", "run2")}:
        effective_blocked_labels.add("csig01")
    ...
    if policy in {"phase11ak", "phase11al", "phase11am", "phase11an", "phase11ao", "phase11ap", "phase11aq", "phase11ar", "phase11as", "phase11at", "phase11au", "phase11aw", "phase11ay"}:
        effective_blocked_labels.add("rout100")
    ...
    if policy in {"phase11am", "phase11an", "phase11ao", "phase11ap", "phase11aq", "phase11ar", "phase11as", "phase11at", "phase11au", "phase11aw", "phase11ay"} and (city, run) not in {("tokyo", "run1"), ("tokyo", "run3")}:
        effective_blocked_labels.add("csig05hvr")
    ...
    if policy in {"phase11am", "phase11an", "phase11ao", "phase11ap", "phase11aq", "phase11ar", "phase11as", "phase11at", "phase11au", "phase11aw", "phase11ay"} and (city, run) not in {("tokyo", "run3"), ("nagoya", "run3"), ("tokyo", "run1")}:
        effective_blocked_labels.add("csig05psh")
    ...
    if policy in {"phase11am", "phase11an", "phase11ao", "phase11ap", "phase11aq", "phase11ar", "phase11as", "phase11at", "phase11au", "phase11aw", "phase11ay"} and (city, run) != ("tokyo", "run3"):
        effective_blocked_labels.add("csig05em")
    ...
    if policy in {"phase11am", "phase11an", "phase11ao", "phase11ap", "phase11aq", "phase11ar", "phase11as", "phase11at", "phase11au", "phase11aw", "phase11ay"} and (city, run) not in {("nagoya", "run2"), ("tokyo", "run1"), ("tokyo", "run3")}:
        effective_blocked_labels.add("csig01hr")
    # Phase 11an: c5p1hvr (csig05+psig1+holdvrlx 4-knob) gives +104.6m on
    # tokyo/run1 and +28.4m on nagoya/run3 offline.
    if policy in {"phase11an", "phase11ao", "phase11ap", "phase11aq", "phase11ar", "phase11as", "phase11at", "phase11au", "phase11aw", "phase11ay"} and (city, run) not in {("tokyo", "run1"), ("nagoya", "run3")}:
        effective_blocked_labels.add("c5p1hvr")
    # Phase 11an: c1p1hr (csig01+psig1+holdrlx triple) gives +7.3m on tokyo/run3 offline.
    if policy in {"phase11an", "phase11ao", "phase11ap", "phase11aq", "phase11ar", "phase11as", "phase11at", "phase11au", "phase11aw", "phase11ay"} and (city, run) != ("tokyo", "run3"):
    ...
    if policy in {"phase11ao", "phase11ap", "phase11aq", "phase11ar", "phase11as", "phase11at", "phase11au", "phase11aw", "phase11ay"} and (city, run) != ("nagoya", "run2"):
    ...
    if policy in {"phase11ao", "phase11ap", "phase11aq", "phase11ar", "phase11as", "phase11at", "phase11au", "phase11aw", "phase11ay"} and (city, run) not in {("tokyo", "run1"), ("nagoya", "run1")}:
        effective_blocked_labels.add("c5nbhr")
    # Phase 11ap: c005hr (csig005+holdrlx) marginal +2.6m on tokyo/run1, +9.5m on nagoya/run1.
    if policy in {"phase11ap", "phase11aq", "phase11ar", "phase11as", "phase11at", "phase11au", "phase11aw", "phase11ay"} and (city, run) not in {("tokyo", "run1"), ("nagoya", "run1")}:
        effective_blocked_labels.add("c005hr")
    # Phase 11aq: r05 (--ratio 0.5) marginal +5.0/+3.9/+2.3m on tokyo/run1, tokyo/run3, nagoya/run1.
    if policy in {"phase11aq", "phase11ar", "phase11as", "phase11at", "phase11au", "phase11aw", "phase11ay"} and (city, run) not in {("tokyo", "run1"), ("tokyo", "run3"), ("nagoya", "run1")}:
        effective_blocked_labels.add("r05")
    # Phase 11aq: c005ga (csig005+glonassar) marginal +1.8/+3.3m on tokyo/run1, tokyo/run3.
    if policy in {"phase11aq", "phase11ar", "phase11as", "phase11at", "phase11au", "phase11aw", "phase11ay"} and (city, run) not in {("tokyo", "run1"), ("tokyo", "run3")}:
    ...
    if policy in {"phase11ar", "phase11as", "phase11at", "phase11au", "phase11aw", "phase11ay"} and (city, run) not in {("tokyo", "run1"), ("nagoya", "run2")}:
        effective_blocked_labels.add("onlyG")
    # Phase 11as: oGc05 (onlyG + csig05) +14.3m on tokyo/run1.
    if policy in {"phase11as", "phase11at", "phase11au", "phase11aw", "phase11ay"} and (city, run) != ("tokyo", "run1"):
        effective_blocked_labels.add("oGc05")
    # Phase 11as: oGc005 (onlyG + csig005) +10.4m on nagoya/run2.
    if policy in {"phase11as", "phase11at", "phase11au", "phase11aw", "phase11ay"} and (city, run) != ("nagoya", "run2"):
        effective_blocked_labels.add("oGc005")
    # Phase 11as: oGp1 (onlyG + psig1) +2.1/+3.0m on nagoya/run1, nagoya/run3.
    if policy in {"phase11as", "phase11at", "phase11au", "phase11aw", "phase11ay"} and (city, run) not in {("nagoya", "run1"), ("nagoya", "run3")}:
        effective_blocked_labels.add("oGp1")
    # Phase 11at: oGp1hr (onlyG + psig1 + holdrlx) +15.4m on tokyo/run1.
    if policy in {"phase11at", "phase11au", "phase11aw", "phase11ay"} and (city, run) != ("tokyo", "run1"):
        effective_blocked_labels.add("oGp1hr")
    # Phase 11at: oGp1c05 (onlyG + psig1 + csig05) +9.2m nagoya/run3, +2.0m nagoya/run1.
    if policy in {"phase11at", "phase11au", "phase11aw", "phase11ay"} and (city, run) not in {("nagoya", "run3"), ("nagoya", "run1")}:
        effective_blocked_labels.add("oGp1c05")
    # Phase 11at: oGr05 (onlyG + ratio 0.5) marginal +2.2/+3.7m on tokyo/run3, nagoya/run2.
    if policy in {"phase11at", "phase11au", "phase11aw", "phase11ay"} and (city, run) not in {("tokyo", "run3"), ("nagoya", "run2")}:
        effective_blocked_labels.add("oGr05")
    # Phase 11at: oGc01 (onlyG + csig01) marginal +3.1m on nagoya/run1.
    if policy in {"phase11at", "phase11au", "phase11aw", "phase11ay"} and (city, run) != ("nagoya", "run1"):
        effective_blocked_labels.add("oGc01")
    # Phase 11at: oGem10 (onlyG + em10) marginal +1.5m/+1.1m on tokyo/run3, nagoya/run3.
    if policy in {"phase11at", "phase11au", "phase11aw", "phase11ay"} and (city, run) not in {("tokyo", "run3"), ("nagoya", "run3")}:
    ...
    if policy in {"phase11au", "phase11aw", "phase11ay"} and (city, run) not in {("tokyo", "run2"), ("tokyo", "run1"), ("nagoya", "run1")}:
